...
data_root=$HOME/scratch/data/dataset/kd_prediction/$dataset/sft-$max_shift-mis-$max_miss-deg-$max_degree
output_root=$HOME/scratch/results/kd_prediction/$dataset/sft-$max_shift-mis-$max_miss-deg-$max_degree
